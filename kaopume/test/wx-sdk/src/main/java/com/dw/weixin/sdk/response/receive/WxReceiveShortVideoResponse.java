...
public class WxReceiveShortVideoResponse  extends WxReceiveResponse {
	...
	public WxReceiveShortVideoResponse() {
		setMsgType(WxEnumTransform.MSG_TYPE.shortvideo.toString());
	}
